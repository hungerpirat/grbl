...
#define CPU_MAP_ARDUINO_UNO_WITH_MR_BEAM_SHIELD // Arduino Uno CPU
...
#define HOMING_CYCLE_0 ((1<<X_AXIS)|(1<<Y_AXIS))  // REQUIRED: Laser cutter has no Z axis.
