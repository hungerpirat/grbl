...
//----------------------------------------------------------------------------------------
...
#ifdef CPU_MAP_ARDUINO_UNO_WITH_MR_BEAM_SHIELD // AVR 328p, for Mr Beam Lasercutter. Supports PWM for laser and tec driver.
  ...
  #define LIMIT_PIN       PINB
  #define LIMIT_PORT      PORTB
  #define X_LIMIT_BIT     5  // Uno Digital Pin 13 (NOTE: D13 can't be pulled-high input due to LED.)
